...
#   VCD_FILE       - Path to VCD activity file (default: sim_out/reversible.vcd)
#
...
set TOP_MODULE "reversible_wrapper"
...
set POWER_RPT "$repo_root/power_reports/power_reversible_wrapper_tt_025C_1v80.rpt"
set POWER_VERBOSE_RPT "$repo_root/power_reports/power_reversible_wrapper_verbose.rpt"
