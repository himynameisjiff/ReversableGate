module ripple_adder_wrapper (cin,
 ...
 sky130_fd_sc_hd__a21oi_1 _093_ (.A1(\u_rip.gen_fa[2].fa.b ),
    ...
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__o21a_1 _094_ (.A1(\u_rip.gen_fa[2].fa.b ),
    .A2(_059_),
    .B1(_060_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _104_ (.A1(\u_rip.gen_fa[4].fa.b ),
    ...
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__o21a_1 _105_ (.A1(\u_rip.gen_fa[4].fa.b ),
    .A2(_068_),
    .B1(_069_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _115_ (.A1(\u_rip.gen_fa[6].fa.b ),
    ...
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__o21a_1 _116_ (.A1(\u_rip.gen_fa[6].fa.b ),
    .A2(_077_),
    .B1(_078_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _120_ (.A(\u_rip.gen_fa[7].fa.b ),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__nand2_1 _121_ (.A(\u_rip.gen_fa[7].fa.b ),
    .B(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
