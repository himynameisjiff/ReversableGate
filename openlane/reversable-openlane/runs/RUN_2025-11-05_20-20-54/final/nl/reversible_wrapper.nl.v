module reversible_wrapper (cin,
 ...
 sky130_fd_sc_hd__and4bb_1 _192_ (.A_N(net53),
    ...
    .D(_085_),
    .X(_094_));
 sky130_fd_sc_hd__xor2_1 _193_ (.A(net70),
    .B(_082_),
    .X(_095_));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\u_rev.rfa_bits[3].fa_ga ),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\u_rev.rfa_bits[6].fa_ga ),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(\u_rev.rfa_bits[1].fa_ga ),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(\u_rev.rfa_bits[7].fa_ga ),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold5 (.A(\u_rev.rfa_bits[5].fa_ga ),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold6 (.A(\u_rev.rfa_bits[4].fa_ga ),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold7 (.A(\u_rev.rfa_bits[2].fa_ga ),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold8 (.A(\u_rev.rfa_bits[4].rfa.anc_in ),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold9 (.A(\u_rev.rfa_bits[0].fa_ga ),
    .X(net71));
